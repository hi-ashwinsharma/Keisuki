...
enum class ColorToken(
    ...
    val containerColor: Color
        ...
        get() {
            ...
            return if (isDark) {
                // Ensure the container is comfortably dark and never blindingly bright on dark/AMOLED backgrounds
    ...
    val onContainerColor: Color
        ...
        get() {
            ...
            return if (isDark) {
                // In dark mode, guarantee text is bright, ultra-crisp, and never faded
